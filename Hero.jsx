...
const Hero = () => {
  return (
    ...
    <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
        <p className='text-gray-400 font-bold p-2'>STRUGGLING WITH COURSE DECISIONS AND PLANNING?</p>
        ...
        <div>
            <button className='bg-gray-500 w-[150px] rounded font-bold mx-auto self-center h-8 my-6 text-black'>Start Planning</button>
        </div>
